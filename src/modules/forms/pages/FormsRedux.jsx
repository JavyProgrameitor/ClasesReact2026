...
export const FormsRedux = () => {

  const dispatch = useDispatch()

  const tasks = useSelector((state) => state.tareas.taskList)
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.name || !formData.task) {
      console.error("Debes rellenar los campos obligatorios")
      return
    }
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6">Gestión de Tareas con Redux</h1>
            ...
            {tasks.map((tarea) => (
              ...
              >
                ...
                <Checkbox
                  ...
                  onCheckedChange={() => dispatch(toggleTask(tarea.id))}
                />
        ...
        <div>
          <Card className="sticky top-6">
            ...
            <CardHeader>
              ...
              <CardDescription>
                Rellena los datos para asignar una nueva tarea.
              </CardDescription>
            </CardHeader>
